...
# auto files delete
AUTO_FILE_DELETE = is_enabled((environ.get('AUTO_FILE_DELETE', "False")), False)
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002607525840)) # movies request channel, else log channel
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002607525840")) 
PORT = int(environ.get('PORT', 8080))
NO_PORT = bool(environ.get('NO_PORT', False))
APP_NAME = None
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('APP_NAME', "IMAXBOT")
else:
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '0.0.0.0'))
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
URL = "https://b-sfb-eecfd21a1ea1.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://b-sfb-eecfd21a1ea1.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://b-sfb-eecfd21a1ea1.herokuapp.com/".format(FQDN)
else:
    URL = "https://b-sfb-eecfd21a1ea1.herokuapp.com/".format(FQDN)
